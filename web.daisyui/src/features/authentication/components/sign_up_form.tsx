        ...
        try {
            ...
            switch (result) {
                case SignInStep.CONFIRM_SIGNUP:
                    toast.success('Sign up code sent. Please check your email for your sign up code');
                ...
                <div className="card bg-base-100 shadow-xl">
                    <div className="card-body">
                            ...
                            <div className="space-y-4">
                                <div className="form-control">
                                    ...
                                    {form.errors.firstName && (
                                        <label className="label">
                                            <span className="label-text-alt text-error">{form.errors.firstName}</span>
                                        </label>
                                    )}
                                </div>
                                <div className="form-control">
                                    ...
                                    {form.errors.lastName && (
                                        <label className="label">
                                            <span className="label-text-alt text-error">{form.errors.lastName}</span>
                                        </label>
                                    )}
                                </div>
                                <div className="form-control">
                                ...
                                <div className="form-control">
                                    ...
                                    {form.errors.terms && (
                                        <label className="label">
                                            <span className="label-text-alt text-error">{form.errors.terms}</span>
                                        </label>
                                    )}
                                </div>
                            </div>
                        ...
                        <div className="flex justify-between items-center mt-6">
                            ...
                            <button type="submit" form="signup-form" className="btn btn-primary">
                                Sign Up
                            </button>
                        </div>
                    </div>
