...
/** Path where the HAL stylesheet is served */
export const HAL_CSS_PATH = '/_assets/hal.css';

/** Raw CSS content loaded as text at startup */
const __dirname = dirname(fileURLToPath(import.meta.url));
export const halStyles = readFileSync(join(__dirname, 'hal.css'), 'utf-8');
